...
<body class="w3-white">
	<div class="w3-content w3-padding-large w3-margin-top" id="login">
		<div class="w3-light-grey w3-padding-large w3-padding-32 w3-margin-top" id="contact">
			<div class="w3-centered" style="width:300px;height:120px;margin:auto;" >
				<img src="../w3images/fig.jpg" style="width:300px;height:120px;margin:auto;" >
			</div>
			<h3 class="w3-center">Administrator Login</h3>
			<hr>
