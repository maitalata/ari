...
<div class="w3-top">
  <div class="w3-bar w3-blue-gray w3-card-2 w3-left-align w3-large">
    ...
    <a href="index.php" class="w3-bar-item w3-button w3-padding-large w3-hover-white"><i class="fa fa-home"></i></a>
    <a href="login.php" class="w3-bar-item w3-button w3-hide-small w3-padding-large w3-hover-white">Sign In</a>
    <a href="register.php" class="w3-bar-item w3-button w3-hide-small w3-padding-large w3-hover-white">Sign Up</a>
  ...
  <div id="navDemo" class="w3-blue-gray w3-hide w3-hide-large w3-hide-medium w3-large">
    <a href="login.php" class="w3-bar-item w3-button w3-padding-large">Sign In</a>
    <a href="register.php" class="w3-bar-item w3-button w3-padding-large">Sign Up</a>
    <a href="index.php#about" class="w3-bar-item w3-button w3-padding-large">About</a>
    <a href="index.php#contact" class="w3-bar-item w3-button w3-padding-large">Contact</a>
  </div>
</div>